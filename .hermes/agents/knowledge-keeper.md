...
<!-- source: knowledge/claude-memory/MEMORY.md -->
# Memory Index — one-context

- [Cost is no constraint](cost-no-limit.md) — 水猿明确不要刻意省 token；按效果选，不按成本选
- [Task tool subagent registry quirk](subagent-task-tool-registry.md) — `.claude/agents/` 项目级角色 spawn 不进，需用 general-purpose 在 prompt 里扮演
- [Trust but verify every subagent](trust-but-verify-subagent.md) — subagent 报"完毕"后主管必做 grep + 抽样 + e2e 三层验证
- [skill-eval-runner Phase 1 done (2026-05-30)](skill-eval-runner-phase1-done.md) — Phase 1 收尾事实 + 水猿待审 4 项 + Phase 2 待办

<!-- source: knowledge/claude-memory/README.md -->
...
<!-- source: knowledge/claude-memory/cost-no-limit.md -->
---
name: cost-no-limit
...
<!-- source: knowledge/claude-memory/skill-eval-runner-phase1-done.md -->
---
...
<!-- source: knowledge/claude-memory/subagent-task-tool-registry.md -->
---
...
<!-- source: knowledge/claude-memory/trust-but-verify-subagent.md -->
---
...
<!-- source: knowledge/skills/info-radar.md -->
# 信息雷达 Skill 使用手册
...
| 新建 content-pipeline / 中视频 spec / 口播立项 | `knowledge/standards/content-pipeline-tts-routing.md` + `features/_template/spec-content-pipeline.md` — **默认 action=0**，勿因双人讲稿自动选 action=3 |
